!function(){let scriptTag = document.currentScript || document.querySelector('script[src*="aida-chatbot.min.js"]');
    ...
    let t=document.createElement("div");t.id="aida-chatbot-container",t.dir="ltr",t.innerHTML=`
    <style>
    /*
    ...
    <section class="chatbot" lang="en">
      ...
      <div class="chat-input">
        ...
        <button class="send-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="20px" class="img5" viewBox="0 0 24 24" fill="none">
            <g id="SVGRepo_bgCarrier" stroke-width="0"/>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
